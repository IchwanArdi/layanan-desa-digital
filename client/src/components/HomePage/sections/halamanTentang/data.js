...
export const navItems = [
  ...
  { key: 'visiMisi', icon: 'BookOpen', label: 'Visi & Misi' },
  { key: 'perangkat', icon: 'Users', label: 'Perangkat Desa' },
  { key: 'sejarah', icon: 'Menu', label: 'Sejarah' },
  { key: 'fiturGrid', icon: 'Star', label: 'Program Unggulan' },
];
