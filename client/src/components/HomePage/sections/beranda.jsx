      ...
      <section className="bg-dark relative overflow-hidden">
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-10 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[calc(100vh-160px)]">
            {/* Text Section - no delay for LCP */}
            <div className="order-1 lg:order-1 text-center lg:text-left space-y-6 lg:space-y-8 opacity-100 translate-y-0 transition-none">
              {/* Badge */}
              ...
              {/* Subtitle */}
              <p className="text-gray-300 text-lg sm:text-lg lg:text-xl leading-relaxed max-w-2xl mx-auto lg:mx-0">Ajukan data dan sampaikan pengaduan dengan mudah, cepat, dan langsung ke perangkat desa dalam satu platform terintegrasi.</p>

              {/* CTA */}
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
                <Link
                  to="/auth/login"
                  className="group relative px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold rounded-2xl overflow-hidden transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg"
                >
                  ...
                  <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 shadow-2xl border border-gray-700/50 backdrop-blur-sm">
                    <div className="aspect-video bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-2xl flex items-center justify-center relative overflow-hidden">
                      ...
                      <div className="absolute inset-0">
                        <div className="absolute top-1/4 left-1/4 w-16 h-16 bg-green-500/20 rounded-full animate-bounce"></div>
